...
var ModuloJuegoSsComponent = /** @class */ (function () {
    function ModuloJuegoSsComponent() {
        ...
        this.transferdata = "/assets/images/iconos/solIcon.png";
        this.receivedData = [];
    }
    ModuloJuegoSsComponent.prototype.transferDataSuccess = function ($event) {
        this.receivedData.push(this.transferdata);
    };
